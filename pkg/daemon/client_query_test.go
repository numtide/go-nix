...
func TestQueryPathInfo(t *testing.T) {
	...
	// connects at proto 1.23 (MinProtocolVersion) and calls QueryPathInfo.
	// At proto 1.23 (which is >= ProtoVersionPathInfoMeta = 1.16), the full
	// PathInfo including ultimate/sigs/ca is sent.
	t.Run("Proto123", func(t *testing.T) {
		rq := require.New(t)
...
func TestQueryValidPaths(t *testing.T) {
	...
	// connects at proto 1.23 (MinProtocolVersion, which is below
	// ProtoVersionSubstituteOk = 1.27). Calls QueryValidPaths with
	// substituteOk=true. At proto < 1.27, the substituteOk field is NOT
	// sent on the wire.
	t.Run("PreSubstituteOk", func(t *testing.T) {
		rq := require.New(t)
		mock := newMockDaemonWithVersion(t, daemon.ProtoVersion(1, 23))
...
func TestQuerySubstitutablePaths(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		rq := require.New(t)
		mock := newMockDaemon(t)
...
func TestQueryValidDerivers(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		rq := require.New(t)
		mock := newMockDaemon(t)
...
func TestQueryDerivationOutputMap(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		rq := require.New(t)
		mock := newMockDaemon(t)
...
func TestQueryRealisation(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		rq := require.New(t)
		mock := newMockDaemon(t)

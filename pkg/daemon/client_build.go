...
func (c *Client) BuildPaths(ctx context.Context, paths []string, mode BuildMode, opts ...ExecOption) error {
	resp, err := c.Execute(ctx, OpBuildPaths, append(opts, WithBody(func(enc *wire.Encoder) error {
...
func (c *Client) BuildPathsWithResults(
	ctx context.Context,
	paths []string,
	mode BuildMode,
	opts ...ExecOption,
	...
	// send request
	resp, err := c.Execute(ctx, OpBuildPathsWithResults, append(opts, WithBody(func(enc *wire.Encoder) error {
		if err := enc.WriteStrings(paths); err != nil {
			return err
		}
...
func (c *Client) EnsurePath(ctx context.Context, path string, opts ...ExecOption) error {
	resp, err := c.Execute(ctx, OpEnsurePath, append(opts, WithBody(func(enc *wire.Encoder) error {
...
func (c *Client) BuildDerivation(
	...
	// send the args
	resp, err := c.Execute(ctx, OpBuildDerivation, append(opts, WithBody(req.MarshalNix))...)
	if err != nil {
		return nil, err
	}
